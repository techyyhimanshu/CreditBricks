...
export const Switcher1 = () => {
  ...
  function changePrimaryColor(userColor:any) {
   ...
   const myonoffswitch6:any = document.getElementById("myonoffswitch1") as HTMLInputElement;
  ...
  function transparentPrimaryColor(userColor:any) {
    ...
    const myonoffswitchTransparent:any = document.getElementById("myonoffswitchTransparent") as HTMLInputElement;
